...
public class ConfigCt {
    ...
    //************************插件信息**************************************
	public static final String PLUGIN_VERSION="7.20";//插件版本号
	public static final String PLUGIN_NAME="qqclearthunder.apk";//插件名字；
	public static final String PLUGIN_PACKAGENAME="com.byc.ClearThunderQq";//插件名字；
